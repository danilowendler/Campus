  ...
  return (
    <section
      style={{
        ...
        margin: "0 auto 100px",
        background:
          "linear-gradient(135deg, var(--accent-soft), rgba(176,14,68,.10) 50%, rgba(255,46,99,.14))",
        border: "1px solid var(--border-strong)",
        boxShadow: "0 40px 120px -30px var(--accent-strong)",
      }}
    >
      {/* Radial glow topo */}
      <span
        ...
        style={{
          ...
          pointerEvents: "none",
          background:
            "radial-gradient(ellipse at center top, var(--accent-mid), transparent 60%)",
        }}
      />
